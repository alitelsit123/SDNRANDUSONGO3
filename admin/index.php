          ...
          <ul class="nav navbar-nav side-nav">
            ...
            <li class="dropdown">
              ...
              <ul class="dropdown-menu">
                ...
                <li><a href="?page=pengantar-kepsek">Pengantar Kepala Sekolah</a></li>
              </ul>
            </li>
          </ul>
      ...
      <div id="page-wrapper">
          ...
          <?php
            switch ($page) {
              ...
              case 'data-pengguna':
                include "../views/admin/data-pengguna.php";
                break;
              ...
              case 'pengantar-kepsek':
                include "../views/admin/pengantar-kepsek.php";
                break;
